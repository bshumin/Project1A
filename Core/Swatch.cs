...
namespace RogueSharpV3Tutorial.Core
{
    ...
    {
        // http://paletton.com/#uid=73d0u1kgLbtbGqNdPi8kZ7OpP44k6Cf53ImK58iR8capf39Ek5qgb2NnT41jT74c8bJ8Xkfg9b87fO8+9Yk28CoL7d

        public static RLColor PrimaryLightest = new RLColor(86, 136, 127);
        public static RLColor PrimaryLighter = new RLColor(52, 92, 85);
        public static RLColor Primary = new RLColor(28, 58, 53);
        public static RLColor PrimaryDarker = new RLColor(14, 39, 35);
        public static RLColor PrimaryDarkest = new RLColor(4, 21, 18);
        ...
        public static RLColor AlternateLightest = new RLColor(126, 114, 94);
        public static RLColor AlternateLighter = new RLColor(79, 71, 57);
        public static RLColor Alternate = new RLColor(73, 60, 38);
        public static RLColor AlternateDarker = new RLColor(69, 53, 26);
        public static RLColor AlternateDarkest = new RLColor(57, 41, 13);

        public static RLColor ComplimentLightest = new RLColor(181, 169, 160);
        public static RLColor ComplimentLighter = new RLColor(150, 136, 126);
        public static RLColor Compliment = new RLColor(120, 105, 95);
        public static RLColor ComplimentDarker = new RLColor(83, 70, 62);
        public static RLColor ComplimentDarkest = new RLColor(77, 55, 41);
